...
ggplot(data = objects, aes(x=Year, y=num_objects, color = Entity)) +
...
ggplot(data = extrapolated_data, aes(x=Year, y=predicted_launches, color = Entity)) +
  geom_smooth(se = FALSE, method = loess) +
  theme(
    axis.text.x = element_text(size = 8, face = "bold"),
    axis.text.y = element_text(size = 8, face = "bold"),
  ...
  labs(
    x = "year of launch",
    y = "number of objects launched",
    title = "Figure 3: Number of objects launched into space by year (2000 to 2100)",
    subtitle = "data collected from United Nations Office of Outer Space Affairs",
    caption = "objects are defined as satelllites, probes, landers, crewed spacecrafts, and space station flights",
    color = "Country"
  )
